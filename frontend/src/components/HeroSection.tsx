    ...
    <section id="hero" className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full flex items-end justify-start">
        <div className="max-w-[2560px] mx-auto px-6 lg:px-8 xl:px-12 2xl:px-16 w-full">
          <div className="max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-4xl 2xl:max-w-full flex justify-center sm:justify-start">
            <div className="space-y-4 md:space-y-5 lg:space-y-6 xl:space-y-8 2xl:space-y-12 3xl:space-y-16 py-12 md:py-14 lg:py-16 xl:py-10 2xl:py-24 3xl:py-28 flex max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-4xl 2xl:max-w-6xl 3xl:max-w-8xl flex-col">
              ...
              >
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-6xl 2xl:text-7xl flex md:flex-row flex-col md:gap-x-3 lg:gap-x-4 xl:gap-x-5 2xl:gap-x-6 gap-x-2 w-full justify-start text-white leading-tight font-sans font-semibold">
                  Find Your Perfect Hostel Space
                </h1>
              </motion.div>

              <motion.p
                className="text-base  sm:text-lg md:text-xl lg:text-xl xl:text-3xl 2xl:text-4xl 3xl:text-5xl text-center sm:text-start 3xl:text-5xl text-gray-300 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-2xl 2xl:max-w-4xl 3xl:max-w-6xl font-body"
