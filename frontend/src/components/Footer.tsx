...
export function Footer() {
  return (
    <footer className="bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 text-white py-16 relative overflow-hidden">
      ...
      <div className="max-w-[2560px] mx-auto px-6 lg:px-8 xl:px-12 2xl:px-16 relative z-10">
        <div className="grid md:grid-cols-4 gap-8 lg:gap-12 xl:gap-16">
          ...
          >
            <div className="flex md:flex-row flex-col items-center gap-4 mb-4">
              ...
              <motion.h3 className="text-2xl font-heading font-sans italic font-medium" whileHover={{ scale: 1.05 }}>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="white" viewBox="0 0 256 256">
          ...
          >
            ...
            <ul className="space-y-3 text-gray-300">
              {[
                ...
                { href: "#branch1-contact", label: "Contact", color: "hover:text-green-400" },
              ].map((link, index) => (
                <motion.li
                  key={link.label}
                  whileHover={{ x: 5 }}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <motion.div className="flex items-center justify-center gap-2 mb-4" animate={{ y: [0, -5, 0] }} transition={{ duration: 3, repeat: Infinity }}>
            <Heart className="w-4 h-4 text-pink-400" />
            <span className="font-body">
              Made with love By <a className="underline" target="_blank" href="https://www.digilynk.in">Digilynk</a>
            </span>
