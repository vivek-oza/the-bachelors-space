  ...
  return (
    ...
    >
      <div className="max-w-[2560px] mx-auto px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        >
          <motion.div
            className="inline-flex items-center gap-2 bg-yellow-100 text-yellow-700 px-4 py-2 lg:px-6 lg:py-3 rounded-full mb-4 lg:mb-6"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            <Calendar className="w-4 h-4 lg:w-5 lg:h-5 xl:w-6 xl:h-6" />
            <span className="font-medium font-body text-sm lg:text-base">Yearly Plans</span>
          </motion.div>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center pt-2 border-t">
                      ...
                      <Badge
                        variant="outline"
                        className="border-purple-300 text-purple-700 font-body"
                      >
